...
/*
Create a monochrome Windows bitmap given width, height, an array of
pixels (True/False), and an optional palette.
...
Example:
    ...
    var oneblackpixel = bmp(1, 1, [True]);
*/
function bmp_mono(width, height, pixarray, palette = ['ffffff', '000000']) {
    var widthpadded = Math.ceil(width/8)*8;
...
export { bmp_rgb, bmp_rle8, bmp_mono };